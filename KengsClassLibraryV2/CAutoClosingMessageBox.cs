...
namespace KengsLibraryCs
{
    public class CAutoClosingMessageBox
    {
        ...
        CAutoClosingMessageBox(string text, string caption, int timeout, MessageBoxButtons buttons = MessageBoxButtons.OK, DialogResult timerResult = DialogResult.None)
        {
            _caption = caption;
        ...
        /// <param name="timeout">หมดเวลา ms</param>
        /// <param name="buttons">ปุ่มที่จะแสดง</param>
        /// <param name="timerResult">?</param>
        /// <returns></returns>
        public static DialogResult Show(string text, string caption, int timeout, MessageBoxButtons buttons = MessageBoxButtons.OK, DialogResult timerResult = DialogResult.None)
        {
            return new CAutoClosingMessageBox(text, caption, timeout, buttons, timerResult)._result;
        }
